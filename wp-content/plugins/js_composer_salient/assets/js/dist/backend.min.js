        ...
        vc.debug = !1, vc.map = _.isUndefined(window.vc_mapper) ? {} : window.vc_mapper, vc.roles = _.isUndefined(window.vc_roles) ? {} : window.vc_roles, vc.Storage = function() {
            ...
            wrapData: function(content) {
                ...
                return content = _.reduce(matches, function(mem, value) {
                    var matches_local = (value = -1 === value.trim().indexOf("vc_pseudo_section_") && !value.trim().match(starts_with_shortcode) ? "[vc_row][vc_column][vc_column_text]" + value + "[/vc_column_text][/vc_column][/vc_row]" : value).match(vc_regexp_shortcode());
                    return mem + (value = !(!_.isArray(matches_local) || _.isUndefined(matches_local[2]) || -1 !== matches_local[2].indexOf("vc_pseudo_section_") || _.isUndefined(vc.map[matches_local[2]]) || !_.isUndefined(vc.map[matches_local[2]].is_container) && vc.map[matches_local[2]].is_container) && _.isEmpty(vc.map[matches_local[2]].as_parent) ? "[vc_row][vc_column]" + value + "[/vc_column][/vc_row]" : value)
    ...
    function($) {
        ...
        window.VcRowView = vc.shortcode_view.extend({
            ...
            changeShortcodeParams: function($find) {
                window.VcTextSeparatorView.__super__.changeShortcodeParams.call(this, $find);
                var icon = $find.get("params"),
            ...
            replaceTemplateVars: function() {
                ...
                _.isEmpty(title) && (title = this.parentObj && this.parentObj.defaultSectionTitle && this.parentObj.defaultSectionTitle.length ? this.parentObj.defaultSectionTitle : window.i18nLocale.section);
                var $panelHeading = this.$el.find(".vc_tta-panel-heading"),
